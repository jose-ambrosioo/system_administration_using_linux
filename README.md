...
Configured and administered server and network services on Red Hat Enterprise Linux for a company, adapted to its business volume. Configured the following services: IP, FTP, YUM, HTTP, DNS, NIS, DHCP, NFSv4, Samba, and openLAD. 
